...
//远程相关目录
var EFFECT_REMOTE_FOLDER= 'http://10.19.96.190/xcar_UI/';
...
//本地目录
var EFFECT_LOC_FOLDER= dw.getConfigurationPath()+'/xcar_UI/';
...
function updateLocalAssets(){
	...
	if(updateMenu()){	
		...
		if(menu.length>0){			
			...
			//setTimeout(function(){document.theForm.updataInfo.value="更新"},1000)
		}
		return;
	}
